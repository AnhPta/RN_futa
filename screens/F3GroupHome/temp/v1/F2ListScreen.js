                ...
                if (item.type_package_app == 2) {
                  return (
                    <TouchableOpacity key={item.barcode} onPress={ () => this.getF2Detail(item)  }>
                      <View style={{ height: 90, backgroundColor: '#ccc', borderBottomWidth: 1, borderColor: '#F3F3F3', display: 'flex', flexDirection: 'row', alignItems:'center', paddingRight: 10, paddingLeft: 1, justifyContent: 'space-between' }}>
